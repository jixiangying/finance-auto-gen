...
values = ['7,483.23', '26,040.03', '52,305.24', '$68.00', '$4,008.94', '$60,336.43']
changes = [-0.22, -0.66, -0.03, -3.48, -0.52, 3.81]
...
ax.set_axis_off()
plt.title('2026年7月2日 早盘(国际) 核心行情快报', fontproperties=prop, fontsize=18, pad=25, fontweight='bold', color='#0f172a')

output_path = 'images/charts/2026-07-02-morning.png'
