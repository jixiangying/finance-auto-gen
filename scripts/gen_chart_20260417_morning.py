...
# 资产数据 (2026-04-16 收盘数据)
assets = ['S&P 500', 'Nasdaq', 'Dow Jones', '10Y Yield', 'Brent Oil']
prices = ['7,041.28', '24,102.70', '48,578.72', '4.32%', '95.14']
changes = ['+0.26%', '+0.36%', '+0.24%', '+0.03%', '+0.22%']
colors = ['#e63946', '#e63946', '#e63946', '#e63946', '#e63946'] # 全部上涨
...
# 绘制标题
plt.text(0.5, 0.95, '全球核心资产行情速览 (2026-04-16 收盘)', 
...
# 保存图片
output_path = 'images/charts/2026-04-17-morning.png'
