...
# Data (Weekly performance for Weekend Review mode)
labels = ['S&P 500', 'Nasdaq Composite', 'Dow Jones', 'WTI Crude Oil', 'Spot Gold', 'Bitcoin (BTC)']
values = ['7,483.24', '25,832.67', '52,900.07', '$68.08', '$4,174.21', '$62,537.00']
changes = [1.80, 2.10, 2.00, -0.70, 2.12, 4.87]
...
for i, (label, value, change) in enumerate(zip(labels, values, changes)):
    ...
    ax.text(0.78, 0.87 - i*0.13, f'{sign}{change:.2f}% (周)', transform=ax.transAxes, fontproperties=prop, fontsize=14, color=color, fontweight='bold', va='center')

ax.set_axis_off()
plt.title('2026年7月5日 周末特刊 核心资产周度涨跌幅', fontproperties=prop, fontsize=18, pad=25, fontweight='bold', color='#0f172a')

output_path = 'images/charts/2026-07-05-morning.png'
