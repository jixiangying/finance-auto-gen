...
prices = ['7,108.40', '24,438.50', '49,310.32', '4,790.00', '103.50']
changes = ['-0.41%', '-0.89%', '-0.36%', '+0.69%', '+1.92%'] 
colors = ['#2a9d8f', '#2a9d8f', '#2a9d8f', '#e63946', '#e63946'] # 红涨绿跌
...
# 绘制标题
plt.text(0.5, 0.95, '全球核心资产行情速览 (2026-04-23 收盘)', 
...
# 保存图片
output_path = 'images/charts/2026-04-24-morning.png'
