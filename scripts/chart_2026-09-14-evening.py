...
# ── 数据 ──────────────────────────────────────────────────────────────────
assets = [
    {'name': '上证指数',   'price': '3,885.33', 'change': '-0.07%', 'up': False},
    {'name': '深证成指',   'price': '13,384.57','change': '-0.64%', 'up': False},
    {'name': '创业板指',   'price': '3,285.58', 'change': '-1.10%', 'up': False},
    {'name': '恒生指数',   'price': '24,917.60','change': '+0.45%', 'up': True},
    {'name': '恒生科技',   'price': '4,317.94', 'change': '-0.06%', 'up': False},
]
