...
# --- 数据 ---
assets = [
    {"name": "标普500\nS&P 500", "value": "7,551.81", "change": "-0.45%", "up": False},
    {"name": "纳斯达克\nNasdaq", "value": "26,111.45", "change": "+0.50%", "up": True},
    {"name": "道琼斯\nDow Jones", "value": "51,462.11", "change": "-1.21%", "up": False},
    {"name": "美债10Y\nUS 10Y Yield", "value": "5.003%", "change": "+1bp", "up": True},
    {"name": "WTI原油\nWTI Crude", "value": "$102.43", "change": "-3.09%", "up": False},
    {"name": "黄金\nGold", "value": "$4,293", "change": "-0.97%", "up": False},
    {"name": "比特币\nBTC/USD", "value": "$75,800", "change": "-0.13%", "up": False},
    {"name": "美元指数\nDXY", "value": "99.82", "change": "+0.17%", "up": True},
]
...
plt.suptitle('2026-09-17 国际市场早报行情卡片', fontsize=14, color='white',
             fontproperties=prop, fontweight='bold', y=1.02)
plt.tight_layout()

out_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))),
                        'images', 'charts', 'chart_2026-09-17-morning.png')
