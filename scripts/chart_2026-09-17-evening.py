...
# ── 数据 ──────────────────────────────────────────────────────────────────
assets = [
    {'name': '上证指数',   'price': '3,875.60', 'change': '-0.41%', 'up': False},
    {'name': '深证成指',   'price': '13,410.37','change': '-0.33%', 'up': False},
    {'name': '创业板指',   'price': '3,307.72', 'change': '-0.40%', 'up': False},
    {'name': '恒生指数',   'price': '24,604.29','change': '-0.44%', 'up': False},
    {'name': '恒生科技',   'price': '4,310.74', 'change': '-0.34%', 'up': False},
]
