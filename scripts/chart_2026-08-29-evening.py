...
assets = [
    # 国内市场
    {'label': '上证指数',    'value': '3952.18',  'chg_d': -0.11,  'chg_w': +1.20,  'cat': '国内'},
    {'label': '沪深300',    'value': '4609.18',  'chg_d': -0.46,  'chg_w': -0.30,  'cat': '国内'},
    {'label': '创业板指',    'value': '3424.40',  'chg_d': -0.80,  'chg_w': -3.42,  'cat': '国内'},
    {'label': '恒生指数',    'value': '25584.79', 'chg_d': +0.07,  'chg_w': -1.63,  'cat': '港股'},
    {'label': '恒生科技',    'value': '4605.15',  'chg_d': -0.50,  'chg_w': -3.38,  'cat': '港股'},
    # 全球市场
    {'label': '标普500',     'value': '—',        'chg_d': -0.30,  'chg_w': +0.49,  'cat': '美股'},
    {'label': '纳斯达克',    'value': '—',        'chg_d': -0.45,  'chg_w': +0.85,  'cat': '美股'},
    {'label': '道琼斯',      'value': '—',        'chg_d': -0.20,  'chg_w': +0.53,  'cat': '美股'},
    # 大宗商品
    {'label': '黄金(现货)',  'value': '$4450',    'chg_d': -3.10,  'chg_w': -3.00,  'cat': '大宗'},
    {'label': 'WTI原油',    'value': '$82.6',    'chg_d': -1.00,  'chg_w': -4.16,  'cat': '大宗'},
    {'label': '美元指数',    'value': '99.703',   'chg_d': +0.55,  'chg_w': +0.60,  'cat': '外汇'},
]
...
out_path = 'images/charts/chart_2026-08-29-evening.png'
