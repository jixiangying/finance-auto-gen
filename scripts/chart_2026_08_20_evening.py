...
# -*- coding: utf-8 -*-
"""
行情数据卡片生成脚本 - 2026-08-20 晚报（国内A股/港股·2026-08-20收盘）
"""
import matplotlib
matplotlib.use('Agg')
...
# 标题
fig.text(0.5, 0.96, '国内A股与港股市场行情复盘  |  2026-08-20 收盘',
...
out_path = os.path.join(out_dir, '2026-08-20-evening.png')
