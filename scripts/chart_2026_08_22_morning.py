...
# -*- coding: utf-8 -*-
"""
行情数据卡片生成脚本 - 2026-08-22 早报（国际市场）
数据基准：2026-08-21（周五）美股收盘
"""
import matplotlib
matplotlib.use('Agg')
...
# ─── 行情数据（2026-08-21 美股收盘）─────────────────────────────────────────
assets = [
    ("S&P 500",    7674.37,  0.43),
    ("纳斯达克",   26171.44, 0.40),
    ("道琼斯",     53276.21, 0.98),
    ("COMEX 黄金", 4621.04,  0.67),
    ("WTI 原油",   86.07,    1.22),
    ("美债10Y(%)", 4.700,   -0.3),    # 单位已换算为 bps 变动量
    ("美元指数",   98.82,   -0.15),
    ("比特币",     77464.00, 1.85),
    ("VIX 恐慌",   15.41,   -3.75),
]
...
# 标题
fig.text(0.5, 0.96, '🌏 国际市场行情复盘  |  2026-08-21 收盘',
         ha='center', va='top', fontsize=16, color=WHITE,
         fontproperties=prop, fontweight='bold')
fig.text(0.5, 0.92, '数据来源：Yahoo Finance / COMEX / CoinMarketCap / TradingEconomics',
...
out_path = os.path.join(out_dir, '2026-08-22-morning.png')
