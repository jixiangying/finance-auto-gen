...
# ─── 行情数据（2026-08-13 美股收盘）─────────────────────────────────────────
assets = [
    ("S&P 500",    7799.00,  0.65),
    ("纳斯达克",   26803.03, 0.81),
    ("道琼斯",     53840.00, 0.13),
    ("罗素2000",   3052.85,  0.24),
    ("费半 SOX",   12456.00, 0.46),
    ("COMEX 黄金", 4414.60,  0.13),
    ("WTI 原油",   81.35,   -2.31),
    ("美债10Y",    4.641,   -0.04),  # 单位 %，用 -4.1bps 表示为 -0.04
    ("比特币",     63369.64,-0.05),
]

# 红涨绿跌（A股惯例，国际报告同用）
colors_bg  = ['#1a1a2e', '#16213e', '#0f3460']
RED   = '#f44b4b'
GREEN = '#2dba5f'
GOLD  = '#f5a623'
WHITE = '#ffffff'
...
# 标题
fig.text(0.5, 0.96, '🌏 国际市场行情复盘  |  2026-08-13 收盘',
         ha='center', va='top', fontsize=16, color=WHITE,
         fontproperties=prop, fontweight='bold')
fig.text(0.5, 0.92, '数据来源：Yahoo Finance / COMEX / CCC',
...
out_path = os.path.join(out_dir, '2026-08-14-morning.png')
