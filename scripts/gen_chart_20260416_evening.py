...
prices = ['4055.55', '14796.33', '3626.27', '26394.26', '5092.08']
changes = ['+0.70%', '+2.05%', '+3.17%', '+1.72%', '+3.67%']
# 红色上涨 🔴 (#e63946)，绿色下跌 🟢 (#2a9d8f)
colors = ['#e63946', '#e63946', '#e63946', '#e63946', '#e63946'] 
...
plt.title('核心指数收盘表现 (2026-04-16)', fontsize=26, fontweight='bold', fontproperties=prop, pad=40)
plt.text(0.5, 0.02, '数据来源：EastMoney / Wind (收盘：2026-04-16)', 
         transform=ax.transAxes, ha='center', fontsize=12, color='#6c757d', fontproperties=prop)

# 保存路径
output_path = 'images/charts/2026-04-16-evening.png'
