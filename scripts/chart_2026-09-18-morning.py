...
# --- 数据 ---
assets = [
    {"name": "标普500\nS&P 500", "value": "7,637.76", "change": "+1.14%", "up": True},
    {"name": "纳斯达克\nNasdaq", "value": "26,418.30", "change": "+1.69%", "up": True},
    {"name": "道琼斯\nDow Jones", "value": "51,778.04", "change": "+0.61%", "up": True},
    {"name": "美债10Y\nUS 10Y Yield", "value": "4.946%", "change": "-5.7bp", "up": False},
    {"name": "WTI原油\nWTI Crude", "value": "$101.13", "change": "-1.27%", "up": False},
    {"name": "黄金\nGold", "value": "$4,301.40", "change": "-2.00%", "up": False},
    {"name": "比特币\nBTC/USD", "value": "$76,550", "change": "+0.99%", "up": True},
    {"name": "美元指数\nDXY", "value": "100.08", "change": "+0.26%", "up": True},
]
...
plt.suptitle('2026-09-18 国际市场早报行情卡片', fontsize=14, color='white',
             fontproperties=prop, fontweight='bold', y=1.02)
plt.tight_layout()

out_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))),
                        'images', 'charts', 'chart_2026-09-18-morning.png')
