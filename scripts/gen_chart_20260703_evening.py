...
# Data (2026-07-03 Friday Closing)
labels = ['上证指数', '深证成指', '创业板指', '科创50']
prices = ['4043.64', '15597.51', '4019.93', '1975.60']
changes = [0.37, 0.64, 0.07, -0.59]
...
ax.set_title('国内核心指数收盘表现 (2026-07-03)', fontsize=16, pad=20, fontproperties=prop, color='white')
...
plt.tight_layout()
output_path = 'images/charts/2026-07-03-evening.png'
