...
values = ['7,499.36', '26,213.72', '52,319.20', '$70.45', '$4,030.00', '$58,120.00']
changes = [0.79, 1.52, 0.26, -0.42, -0.62, -2.94]
...
ax.set_axis_off()
plt.title('2026年7月1日 早盘(国际) 核心行情快报', fontproperties=prop, fontsize=18, pad=25, fontweight='bold', color='#0f172a')

output_path = 'images/charts/2026-07-01-morning.png'
