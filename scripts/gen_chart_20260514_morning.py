...
# 市场数据
data = [
    {"name": "标普500 (S&P 500)", "price": "7,444.25", "change": "+0.58%"},
    {"name": "纳斯达克 (Nasdaq)", "price": "26,402.34", "change": "+1.20%"},
    {"name": "道琼斯 (Dow Jones)", "price": "49,693.20", "change": "-0.14%"},
    {"name": "10年美债收益率", "price": "4.479%", "change": "+0.9bp"},
    {"name": "比特币 (BTC)", "price": "$79,609", "change": "-1.49%"}
]
...
plt.title("全球核心资产行情 (2026-05-13 收盘)", fontproperties=prop, fontsize=18, pad=20)
plt.tight_layout()

# 确保保存目录存在
os.makedirs('images/charts', exist_ok=True)
output_path = 'images/charts/2026-05-14-morning.png'
