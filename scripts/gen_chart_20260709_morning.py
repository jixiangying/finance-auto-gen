...
# Data (July 8, 2026 Wednesday Closing)
labels = ['S&P 500', 'Nasdaq Composite', 'Dow Jones', 'WTI Crude Oil', 'Spot Gold', 'Bitcoin (BTC)', 'FTSE China A50']
values = ['7,482.71', '25,870.65', '52,348.39', '$74.02', '$4,087.10', '$63,351.37', '15,112.17']
changes = [-0.28, 0.20, -1.09, 7.41, -1.69, -0.57, -0.04]
...
ax.set_axis_off()
plt.title('2026年7月9日 早报 核心资产全球表现回顾', fontproperties=prop, fontsize=18, pad=25, fontweight='bold', color='#0f172a')

output_path = 'images/charts/2026-07-09-morning.png'
