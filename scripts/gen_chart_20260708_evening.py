...
# Data (2026-07-08 Wednesday Closing)
labels = ['上证指数', '深证成指', '创业板指', '科创50']
prices = ['3970.88', '14939.73', '3845.35', '1981.39']
changes = [-0.49, -1.87, -1.70, -1.01]
...
ax.set_title('国内核心指数收盘表现 (2026-07-08)', fontsize=16, pad=20, fontproperties=prop, color='white')
...
plt.tight_layout()
output_path = 'images/charts/2026-07-08-evening.png'
