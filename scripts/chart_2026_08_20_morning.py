...
# -*- coding: utf-8 -*-
"""
行情数据卡片生成脚本 - 2026-08-20 早报（国际市场·2026-08-19收盘）
"""
import matplotlib
matplotlib.use('Agg')
...
# ─── 行情数据（2026-08-19 美股收盘）─────────────────────────────────────────
assets = [
    ("S&P 500",    7707.98,  0.21),
    ("纳斯达克",   26331.09, 0.16),
    ("道琼斯",     53463.05, 0.22),
    ("罗素2000",   3032.94,  0.50),
    ("COMEX 黄金", 4356.00, -0.23),
    ("WTI 原油",   84.99,    1.10),
    ("美债10Y",    4.651,   -0.055),  # 单位 %，约 -5.5bps
    ("美元指数",   98.86,   -0.82),
    ("比特币",     64500.00, 0.56),
]
...
# 标题
fig.text(0.5, 0.96, '🌏 国际市场行情复盘  |  2026-08-19 收盘',
         ha='center', va='top', fontsize=16, color=WHITE,
         fontproperties=prop, fontweight='bold')
fig.text(0.5, 0.92, '数据来源：Yahoo Finance / Barchart / COMEX / MarketWatch',
...
out_path = os.path.join(out_dir, '2026-08-20-morning.png')
