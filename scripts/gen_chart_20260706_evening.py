...
# Data (2026-07-06 Monday Closing)
labels = ['上证指数', '深证成指', '创业板指', '科创50']
prices = ['4041.24', '15416.80', '3948.86', '2036.06']
changes = [-0.06, -1.16, -1.77, 1.04]
...
ax.set_title('国内核心指数收盘表现 (2026-07-06)', fontsize=16, pad=20, fontproperties=prop, color='white')
...
plt.tight_layout()
output_path = 'images/charts/2026-07-06-evening.png'
