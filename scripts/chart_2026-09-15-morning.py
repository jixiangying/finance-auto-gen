...
# --- 数据 ---
assets = [
    {"name": "标普500\nS&P 500", "value": "7,619.98", "change": "-0.50%", "up": False},
    {"name": "纳斯达克\nNasdaq", "value": "26,186.41", "change": "-0.60%", "up": False},
    {"name": "道琼斯\nDow Jones", "value": "52,421.20", "change": "-0.30%", "up": False},
    {"name": "美债10Y\nUS 10Y Yield", "value": "4.96%", "change": "+7bp", "up": False},
    {"name": "WTI原油\nCrude Oil", "value": "$102.58", "change": "+1.2%", "up": True},
    {"name": "黄金\nGold", "value": "$4,290", "change": "-0.8%", "up": False},
    {"name": "比特币\nBTC/USD", "value": "$76,443", "change": "-1.5%", "up": False},
    {"name": "美元指数\nDXY", "value": "~104.2", "change": "+0.3%", "up": True},
]
...
plt.suptitle('2026-09-15 国际市场早报行情卡片', fontsize=14, color='white',
             fontproperties=prop, fontweight='bold', y=1.02)
plt.tight_layout()

out_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))),
                        'images', 'charts', 'chart_2026-09-15-morning.png')
