...
# -*- coding: utf-8 -*-
"""
行情数据卡片生成脚本 - 2026-08-18 早报（国际市场·2026-08-17收盘）
"""
import matplotlib
matplotlib.use('Agg')
...
# ─── 行情数据（2026-08-17 美股收盘）─────────────────────────────────────────
assets = [
    ("S&P 500",    7745.38, -0.52),
    ("纳斯达克",   26644.91, -0.32),
    ("道琼斯",     53465.36, -0.51),
    ("罗素2000",   303.85,  -0.41),
    ("COMEX 黄金", 4402.50,  0.35),
    ("WTI 原油",   82.65,    0.79),
    ("美债10Y",    4.710,    0.06),   # 单位 %，+6.0bps
    ("美元指数",   99.42,   -0.12),
    ("比特币",     63450.00, 0.50),
]
...
# 标题
fig.text(0.5, 0.96, '🌏 国际市场行情复盘  |  2026-08-17 收盘',
         ha='center', va='top', fontsize=16, color=WHITE,
         fontproperties=prop, fontweight='bold')
fig.text(0.5, 0.92, '数据来源：Yahoo Finance / FXLeaders / COMEX / CBOE',
...
out_path = os.path.join(out_dir, '2026-08-18-morning.png')
