...
# Data (July 7, 2026 Tuesday Closing)
labels = ['S&P 500', 'Nasdaq Composite', 'Dow Jones', 'WTI Crude Oil', 'Spot Gold', 'Bitcoin (BTC)', 'FTSE China A50']
values = ['7,503.85', '25,818.69', '52,925.15', '$72.42', '$4,141.26', '$63,711.60', '15,118.20']
changes = [-0.45, -1.16, -0.25, 3.98, -0.58, -0.96, -0.05]
...
ax.set_axis_off()
plt.title('2026年7月8日 早报 核心资产全球表现回顾', fontproperties=prop, fontsize=18, pad=25, fontweight='bold', color='#0f172a')

output_path = 'images/charts/2026-07-08-morning.png'
