...
values = ['7,440.43', '25,820.14', '52,182.74', '$70.75', '$4,055.00', '$59,880.00']
changes = [1.18, 2.07, 0.59, 2.75, 0.67, 2.29]
...
for i, (label, value, change) in enumerate(zip(labels, values, changes)):
    ...
    ax.text(0.78, 0.87 - i*0.13, f'{sign}{change}%', transform=ax.transAxes, fontproperties=prop, fontsize=14, color=color, fontweight='bold', va='center')

ax.set_axis_off()
plt.title('2026年6月30日 早盘(国际) 核心行情快报', fontproperties=prop, fontsize=18, pad=25, fontweight='bold', color='#0f172a')

output_path = 'images/charts/2026-06-30-morning.png'
