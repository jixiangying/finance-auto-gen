...
# ── 数据 ──────────────────────────────────────────────────────────────────
assets = [
    {'name': '上证指数',   'price': '3,864.28', 'change': '-0.54%', 'up': False},
    {'name': '深证成指',   'price': '13,287.97','change': '-0.72%', 'up': False},
    {'name': '创业板指',   'price': '3,247.92', 'change': '-1.15%', 'up': False},
    {'name': '恒生指数',   'price': '24,667.24','change': '-1.00%', 'up': False},
    {'name': '恒生科技',   'price': '4,291.17', 'change': '-0.62%', 'up': False},
]
