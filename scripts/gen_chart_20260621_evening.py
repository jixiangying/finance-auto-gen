...
# Data for the chart (Sunday Evening Overview - Weekly Cumulative Change)
assets = [
...
plt.title("本周全球核心资产收盘表现回顾 (2026/06/21 周日晚盘)", fontsize=16, fontproperties=prop, pad=20)
plt.tight_layout()

# Save the plot
output_path = os.path.join(output_dir, "2026-06-21-evening.png")
