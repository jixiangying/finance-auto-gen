...
values = ['7,483.24', '25,832.67', '52,900.07', '$68.78', '$4,181.00', '$61,800.00']
changes = [0.00, 0.00, 0.00, 2.18, 2.79, 0.77]
...
ax.set_axis_off()
plt.title('2026年7月4日 早盘(国际) 核心行情快报', fontproperties=prop, fontsize=18, pad=25, fontweight='bold', color='#0f172a')

output_path = 'images/charts/2026-07-04-morning.png'
