...
# Data (Simulated for May 6, 2026 Morning based on May 5 closing)
assets = ['S&P 500', 'Nasdaq', 'Dow Jones', 'Brent Oil', 'Bitcoin', '10Y Yield']
values = ['7,165.20', '24,710.15', '48,520.40', '$118.50', '$79,850', '4.52%']
changes = [-0.49, -0.73, -0.86, 3.55, -0.44, 2.03] # 4.43 -> 4.52 is +2.03% approx
...
plt.title('核心资产隔夜表现 (2026-05-05 收盘)', fontproperties=prop, fontsize=18, pad=20)
plt.tight_layout()

# Save
output_path = 'images/charts/20260506_morning.png'
