...
# Data for the chart (Monday Morning Overview - Market Status before Open)
assets = [
...
plt.title("全球核心资产表现及早盘波动 (2026/06/22 周一早盘)", fontsize=16, fontproperties=prop, pad=20)
plt.tight_layout()

# Save the plot
output_path = os.path.join(output_dir, "2026-06-22-morning.png")
