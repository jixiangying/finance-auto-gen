...
# -*- coding: utf-8 -*-
"""
行情数据卡片生成脚本 - 2026-08-21 早报（国际市场·2026-08-20收盘）
"""
import matplotlib
matplotlib.use('Agg')
...
# ─── 行情数据（2026-08-20 美股收盘）─────────────────────────────────────────
assets = [
    ("S&P 500",    7641.16,  -0.87),
    ("纳斯达克",   26067.17, -1.00),
    ("道琼斯",     52759.21, -1.32),
    ("罗素2000",   2993.51,  -1.30),
    ("COMEX 黄金", 4360.50,   0.10),
    ("WTI 原油",   86.91,     2.26),
    ("美债10Y",    4.696,     0.045),  # 单位 %，约 +4.5bps
    ("美元指数",   98.75,    -0.11),
    ("比特币",     72150.00,  4.80),
]
...
# 标题
fig.text(0.5, 0.96, '🌏 国际市场行情复盘  |  2026-08-20 收盘',
         ha='center', va='top', fontsize=16, color=WHITE,
         fontproperties=prop, fontweight='bold')
fig.text(0.5, 0.92, '数据来源：Yahoo Finance / Barchart / COMEX / MarketWatch / AP',
...
out_path = os.path.join(out_dir, '2026-08-21-morning.png')
