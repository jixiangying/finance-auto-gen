...
# Data for the chart (Sunday Morning Overview - Weekly Cumulative Change)
assets = [
...
prices = [
    "7,500.58", "51,564.70", "26,517.93", "178.60",
    "4,090.48", "4,252.39", "23,924.81",
    "$80.04", "$4,126.50", "$63,018.00"
]
changes = [
    "周涨 +0.93%", "周涨 +0.71%", "周涨 +2.43%", "周涨 +10.97%",
    "周涨 +1.46%", "周涨 +11.02%", "周跌 -3.21%",
    "周跌 -7.74%", "周跌 -2.12%", "周跌 -0.84%"
]
# Color coding: red for up, green for down
colors = ["red", "red", "red", "red", "red", "red", "green", "green", "green", "green"]
...
plt.title("本周全球核心资产累计表现回顾 (2026/06/21 周日早盘)", fontsize=16, fontproperties=prop, pad=20)
plt.tight_layout()

# Save the plot
output_path = os.path.join(output_dir, "2026-06-21-morning.png")
