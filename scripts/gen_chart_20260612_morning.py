...
prices = [
    "7,394.30", "50,848.75", "25,809.66",
    "4.46%", "$90.44", "$4,212.26", 
    "$62,950.00"
]
changes = [
    "大涨 (+1.75%)", "大涨 (+1.86%)", "大涨 (+2.54%)",
    "收益率下行 (-8 bps)", "大涨 (+2.52%)", "暴涨 (+3.61%)",
    "上涨 (+2.76%)"
]
...
plt.title("隔夜核心数据与宏观指标 (2026/06/12 早盘)", fontsize=18, fontproperties=prop, pad=20)
plt.tight_layout()

# Save the plot
output_path = os.path.join(output_dir, "2026-06-12-morning.png")
