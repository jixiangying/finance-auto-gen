...
# 资产数据 (2026-04-22 收盘)
assets = ['S&P 500', 'Nasdaq', 'Dow Jones', 'Gold', 'Brent Crude']
prices = ['7,137.90', '24,657.57', '49,490.03', '4,757.15', '101.55']
changes = ['+1.05%', '+1.64%', '+0.69%', '+0.45%', '+3.12%'] 
colors = ['#e63946', '#e63946', '#e63946', '#e63946', '#e63946'] # 全部上涨（红涨绿跌）
...
# 绘制标题
plt.text(0.5, 0.95, '全球核心资产行情速览 (2026-04-22 收盘)', 
...
# 保存图片
output_path = 'images/charts/2026-04-23-morning.png'
