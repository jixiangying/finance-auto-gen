...
# Generate corrected cards for 3/22 Evening
create_card("上证指数 (3/20收盘)", "3214.58", "-0.28%", f"{charts_dir}/2026-03-22-shanghai.png", "green")
create_card("深证成指 (3/20收盘)", "10432.15", "-0.42%", f"{charts_dir}/2026-03-22-shenzhen.png", "green")
create_card("恒生指数 (3/20收盘)", "18942.30", "-0.54%", f"{charts_dir}/2026-03-22-hangseng.png", "green")

print("Corrected 3/22 charts generated successfully.")
