...
# Data
labels = ['S&P 500', 'Nasdaq', 'Dow Jones', 'Gold', 'Bitcoin', 'A50 Future']
values = [7365.12, 25838.94, 49910.59, 4695.66, 81467.92, 15667]
changes = [1.46, 2.02, 1.24, 3.07, -0.18, 0.23]
...
ax.set_title('全球核心资产行情表现 (2026-05-07 晨间)', fontproperties=prop, fontsize=16, pad=20)
...
output_path = os.path.join(output_dir, '2026-05-07-morning.png')
