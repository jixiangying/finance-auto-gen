...
# Data (2026-07-07 Tuesday Closing)
labels = ['上证指数', '深证成指', '创业板指', '科创50']
prices = ['3990.24', '15225.11', '3911.91', '2001.59']
changes = [-1.26, -1.24, -0.94, 0.28]
...
ax.set_title('国内核心指数收盘表现 (2026-07-07)', fontsize=16, pad=20, fontproperties=prop, color='white')
...
plt.tight_layout()
output_path = 'images/charts/2026-07-07-evening.png'
