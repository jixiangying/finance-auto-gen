#!/usr/bin/env python3
"""
行情数据卡片生成脚本 - 2026-08-25 早报（常规交易日）
数据基于 2026年8月24日（周一）收盘数据
"""
import matplotlib
matplotlib.use("Agg")
...
assets = [
    ...
    ("道琼斯指数", "53,417.16", "+140.15", +0.26, "点"),
    ("标普500指数", " 7,652.86", " -21.51", -0.28, "点"),
    ("纳斯达克综合", "25,980.19", "-200.26", -0.76, "点"),
    ("美国10年国债", "   4.710", " -0.028", -0.59, "% (收益率)"),
    ("现货黄金",   " 4,625.00", "+108.42", +2.40, "美元/盎司"),
    ("WTI原油",    "   85.45", "  -1.61", -1.85, "美元/桶"),
    ("布伦特原油", "   91.45", "  -2.94", -3.11, "美元/桶"),
    ("美元指数",   "   98.65", "  -0.15", -0.15, ""),
    ("比特币 (BTC)", " 76,200", "  -800", -1.04, "美元"),
]
...
ax.text(6, -0.3,
        "数据截至 2026.08.24 收盘 | 涨跌：红色=上涨  绿色=下跌 | 仅供参考",
        fontproperties=prop, fontsize=8.5, color="#777777",
        va="center", ha="center")

fig.text(0.5, 0.96,
         "2026-08-25 早报  |  全球核心资产收盘行情（8/24收盘）",
         fontproperties=prop_bold, fontsize=13.5, color="#FFFFFF",
         ha="center", va="top")

plt.tight_layout(rect=[0, 0.04, 1, 0.95])
out_path = "images/charts/2026-08-25-morning-chart.png"
