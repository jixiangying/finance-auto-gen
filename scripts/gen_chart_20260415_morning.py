...
# 数据 (2026-04-14 收盘数据)
assets = ['标普 500', '道琼斯', '纳斯达克', '10年期美债收益率', 'WTI 原油']
prices = ['6967.38', '48535.99', '23639.08', '4.255%', '$96.00']
changes = ['+1.17%', '+0.66%', '+1.95%', '-0.035', '-3.00%']
# 红色上涨 🔴 (#e63946)，绿色下跌 🟢 (#2a9d8f)
# 注意：收益率下降对股市通常利好，但在卡片上按数值涨跌着色
colors = ['#e63946', '#e63946', '#e63946', '#2a9d8f', '#2a9d8f'] 
...
plt.title('核心资产行情概览 (2026-04-15 早报)', fontsize=26, fontweight='bold', fontproperties=prop, pad=40)
plt.text(0.5, 0.02, '数据来源：Yahoo Finance / Bloomberg (收盘：2026-04-14)', 
         transform=ax.transAxes, ha='center', fontsize=12, color='#6c757d', fontproperties=prop)

# 保存路径
output_path = 'images/charts/2026-04-15-morning-chart.png'
