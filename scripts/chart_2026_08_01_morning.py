...
assets = [
    # (名称, 现值, 涨跌幅, 上涨=True)
    ('标普500\nS&P 500',   '7,476.00', '+0.52%', True),
    ('道琼斯\nDow Jones',  '52,485.03', '+0.53%', True),
    ('纳斯达克\nNasdaq',   '25,122.18', '+2.78%', True),
    ('美国10Y国债\nUS 10Y', '4.74%',   '+0.08%', True),
    ('黄金 Gold\n($/oz)',  '$4,042.97', '-1.46%', False),
    ('WTI原油\nCrude',     '$84.71',   '+1.06%', True),
    ('BTC比特币',          '$62,702',  '-2.33%', False),
    ('VIX恐慌指数',        '15.99',    '-18.25%', False),
]
...
fig.text(0.5, 0.96, '  2026年08月01日  国际市场早报行情',
         ha='center', va='top', fontsize=15, color=TITLE_COLOR,
         **title_kw)

fig.text(0.5, 0.91, '数据来源：昨日（07-31）收盘终值  |  上涨(红)   下跌(绿)',
...
out_path = os.path.join(out_dir, '2026-08-01-morning-chart.png')
