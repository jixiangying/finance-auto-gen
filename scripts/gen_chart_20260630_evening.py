...
# Data (2026-06-30 Tuesday Closing)
labels = ['上证指数', '创业板指', '科创50', '恒生指数', '恒生科技']
prices = ['4094.40', '4342.71', '2207.86', '22881.02', '4472.23']
changes = [0.50, 2.99, 3.85, -0.63, 1.80]
...
ax.set_title('国内核心指数收盘表现 (2026-06-30)', fontsize=16, pad=20, fontproperties=prop)
...
plt.tight_layout()
output_path = 'images/charts/2026-06-30-evening.png'
