...
# Title
ax.text(0.05, 0.93, "【新周宏观前瞻与大宗关键数据】(2026/06/29 周一)", fontproperties=prop, fontsize=14, fontweight='bold', color='#1e293b')
...
macro_data = [
    ("中国5月规上工业企业利润", "同比大增 21.1% (前5月增18.8%)", "AI算力与电子需求飙升103.9%"),
    ("美国6月新增非农就业人数", "预测: 11.3 - 11.4 万", "因独立日提前至周四发布"),
    ("美国6月失业率", "预测: 4.3%", "关注劳动力市场降温幅度"),
    ("下周特殊假期与活动提示", "7月1日港股休市", "7月3日美股休市 | 6月29日ECB论坛")
]
...
market_data = [
    ("伦敦现货黄金", "$4,028.00 / 盎司", "PCE后重返4k上方"),
    ("WTI原油期货", "$68.86 / 桶", "大跌3.5%创3月以来新低"),
    ("比特币 (BTC)", "$58,540.00", "跌破6万创年内新低"),
    ("美元指数 (DXY)", "101.36", "PCE数据后微跌0.06%")
]
...
plt.tight_layout()
output_path = os.path.join(output_dir, "2026-06-29-morning.png")
