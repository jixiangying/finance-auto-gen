...
# 资产数据
assets = ['S&P 500', 'Nasdaq', 'Dow Jones', 'Gold', 'WTI Crude']
prices = ['7,022.95', '24,016.02', '48,463.72', '4,831.78', '91.29']
changes = ['+0.80%', '+1.60%', '-0.15%', '+2.00%', '-0.40%']  # WTI was volatile, roughly flat to down on peace news
colors = ['#e63946', '#e63946', '#2a9d8f', '#e63946', '#2a9d8f'] # 红涨绿跌
...
# 绘制标题
plt.text(0.5, 0.95, '全球核心资产行情速览 (2026-04-15 收盘)', 
...
# 保存图片
output_path = 'images/charts/2026-04-16-morning.png'
