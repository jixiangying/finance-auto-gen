...
data = [
    {"name": "上证指数", "price": "4,027.74", "change": "-30.04", "pct": "-0.74%", "up": False},
    {"name": "深证成指", "price": "15,314.70", "change": "-346.87", "pct": "-2.21%", "up": False},
    {"name": "创业板指", "price": "3,957.94", "change": "-130.94", "pct": "-3.20%", "up": False},
    {"name": "恒生指数", "price": "25,047.86", "change": "-205.54", "pct": "-0.81%", "up": False},
    {"name": "恒生科技指数", "price": "4,913.86", "change": "-61.50", "pct": "-1.24%", "up": False},
    {"name": "两市成交额", "price": "3.07万亿", "change": "+0.31万亿", "pct": "+11.23%", "up": True},
]
...
output_path = os.path.join(output_dir, '2026-06-05-evening.png')
