...
# Data (Weekly performance / pre-open status for Monday Morning Outlook)
labels = ['S&P 500', 'Nasdaq Composite', 'Dow Jones', 'WTI Crude Oil', 'Spot Gold', 'Bitcoin (BTC)', 'FTSE China A50']
values = ['7,483.24', '25,832.67', '52,900.07', '$68.08', '$4,174.21', '$62,537.00', '15,125.23']
changes = [1.80, 2.10, 2.00, -0.70, 2.12, 4.87, -1.18]
...
for i, (label, value, change) in enumerate(zip(labels, values, changes)):
    ...
    ax.text(0.78, 0.885 - i*0.12, f'{sign}{change:.2f}% (周)', transform=ax.transAxes, fontproperties=prop, fontsize=14, color=color, fontweight='bold', va='center')

ax.set_axis_off()
plt.title('2026年7月6日 新周展望 核心资产全周表现回顾', fontproperties=prop, fontsize=18, pad=25, fontweight='bold', color='#0f172a')

output_path = 'images/charts/2026-07-06-morning.png'
