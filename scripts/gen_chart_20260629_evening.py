...
# Data (2026-06-29 Monday Closing)
labels = ['上证指数', '创业板指', '科创50', '恒生指数', '恒生科技']
prices = ['4073.90', '4216.70', '2126.01', '23026.68', '4393.01']
changes = [1.16, 0.54, 4.61, 1.57, 3.23]
...
ax.set_title('国内核心指数收盘表现 (2026-06-29)', fontsize=16, pad=20, fontproperties=prop)
...
plt.tight_layout()
output_path = 'images/charts/2026-06-29-evening.png'
