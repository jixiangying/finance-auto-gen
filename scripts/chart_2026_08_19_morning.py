...
# -*- coding: utf-8 -*-
"""
行情数据卡片生成脚本 - 2026-08-19 早报（国际市场·2026-08-18收盘）
"""
import matplotlib
matplotlib.use('Agg')
...
# ─── 行情数据（2026-08-18 美股收盘）─────────────────────────────────────────
assets = [
    ("S&P 500",    7691.76, -0.69),
    ("纳斯达克",   26289.71, -1.33),
    ("道琼斯",     53343.40, -0.22),
    ("罗素2000",   3017.89, -1.30),
    ("COMEX 黄金", 4366.00, -1.17),
    ("WTI 原油",   84.95,    0.50),
    ("美债10Y",    4.706,   -0.004),  # 单位 %，约 -0.4bps
    ("美元指数",   99.68,    0.04),
    ("比特币",     64140.00, 1.09),
]
...
# 标题
fig.text(0.5, 0.96, '🌏 国际市场行情复盘  |  2026-08-18 收盘',
...
out_path = os.path.join(out_dir, '2026-08-19-morning.png')
