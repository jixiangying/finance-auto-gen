...
prices = [
    ...
    "$90.54", "$4,331.00", "$59,800.00"
]
changes = [
    "周跌 -2.59%", "周跌 -0.32%", "周跌 -4.68%",
    "周跌 -1.00%", "周跌 -1.98%", "周跌 -0.53%",
    "周涨 +3.64%", "周跌 -4.65%", "周跌 -18.62%"
]
...
plt.title("本周全球核心资产累计表现回顾 (2026/06/07 周日早盘)", fontsize=16, fontproperties=prop, pad=20)
plt.tight_layout()

# Save the plot
output_path = os.path.join(output_dir, "2026-06-07-morning.png")
