...
# 数据准备 (2026-04-01 早报数据，基于 3月31日收盘)
data = [
    ("道琼斯指数", "45,618.31", "+1.00", "2026-04-01-dow.png", "#ff0000"),
    ("标普500", "6,407.06", "+0.60", "2026-04-01-sp500.png", "#ff0000"),
    ("纳斯达克", "20,927.41", "-0.10", "2026-04-01-nasdaq.png", "#00ff00"),
    ("WTI原油", "108.40", "+3.06", "2026-04-01-oil.png", "#ff0000"),
    ("伦敦现货金", "4,581.53", "+1.05", "2026-04-01-gold.png", "#ff0000"),
    ("比特币", "66,934", "-1.20", "2026-04-01-btc.png", "#00ff00")
]
