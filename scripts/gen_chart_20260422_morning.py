...
# 资产数据 (2026-04-21 收盘数据)
assets = ['S&P 500', 'Nasdaq', 'Dow Jones', '10Y Yield', 'Brent Oil']
prices = ['7,064.01', '24,259.96', '49,149.38', '4.30%', '98.48']
changes = ['-0.63%', '-0.59%', '-0.59%', '+0.01%', '+3.10%']
colors = ['#2d6a4f', '#2d6a4f', '#2d6a4f', '#e63946', '#e63946'] # 绿跌红涨
...
# 绘制标题
plt.text(0.5, 0.95, '全球核心资产行情速览 (2026-04-21 收盘)', 
...
# 保存图片
output_path = 'images/charts/2026-04-22-morning.png'
